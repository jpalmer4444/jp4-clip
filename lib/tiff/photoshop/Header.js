...
class Header{
    ...
    write(writer){
        ...
        //buf['writeUInt16' + this.endianness](this.byteOrder, 0);
        //buf['writeUInt16' + this.endianness](this.magicNumber, 2).swap();
        //buf['writeUInt32' + this.endianness](this.ifdOffset, 4);
        //header ALWAYS written at offset 0
        
        //buf['writeUInt16'](Buffer.from(), 0)
        
        //write byteOrder
        
        /*writer.write(this.byteOrder, 0);
        let sixteenArr = new Uint16Array(1);
        sixteenArr[0] = 42;
        writer.write(sixteenArr.toString(), 2, 'UTF8');
        
        var buf = Buffer.alloc(4);
        buf['writeUInt32' + this.endianness](this.ifdOffset, 0, false);
        writer.write(buf, 4);*/
        writer.write(this.raw8Bytes.slice(0, 4));
        var buf = Buffer.alloc(4);
        buf['writeUInt32' + this.endianness](this.ifdOffset, 0, false);
        writer.write(buf, 4);
    }
